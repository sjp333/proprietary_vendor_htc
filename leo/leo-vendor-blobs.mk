...
PRODUCT_COPY_FILES += \
    ...
    vendor/htc/leo/proprietary/lib/egl/libplayback_adreno200.so:system/lib/egl/libplayback_adreno200.so \
    ...
    vendor/htc/leo/proprietary/lib/libOpenCL.so:system/lib/libOpenCL.so \
    ...
    vendor/htc/leo/proprietary/etc/firmware/fw_bcmdhd.bin:system/etc/firmware/fw_bcmdhd.bin \
    vendor/htc/leo/proprietary/etc/firmware/fw_bcmdhd_apsta.bin:system/etc/firmware/fw_bcmdhd_apsta.bin \
    vendor/htc/leo/proprietary/etc/firmware/default.acdb:system/etc/firmware/default.acdb \
    vendor/htc/leo/proprietary/etc/wifi/wpa_supplicant_overlay.conf:system/etc/wifi/wpa_supplicant_overlay.conf \
